    ...
    <>
      ...
      <div className="p-4 bg-white rounded-lg shadow">
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            <h2 className="text-lg font-semibold">Animal Breed Master</h2>
          ...
          <div className="flex items-center gap-2">
            ...
            <div
              ...
              onClick={handleAddAnimalBreed}
            >
              <Plus className="text-[20px]" /> Add New Animal Breed
            </div>
          </div>
        </div>
        ...
        {/* Edit Modal */}
        <Modal
          title={<span className="text-lg font-semibold">Edit Animal Breed</span>}
          open={isEditOpen}
